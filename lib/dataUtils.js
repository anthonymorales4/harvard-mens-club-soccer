    ...
    return players.map((player) => {
      ...
      if (playerWithSupabaseProfile) {
        return {
          ...
          graduation_year: playerWithSupabaseProfile.graduation_year,
          email: playerWithSupabaseProfile.email,
          role: playerWithSupabaseProfile.role,
          phone_number: playerWithSupabaseProfile.phone_number,
          profile_image_url: playerWithSupabaseProfile.profile_image_url,
          ...
          final_club: playerWithSupabaseProfile.final_club,
          current_job: playerWithSupabaseProfile.current_job,
          current_location: playerWithSupabaseProfile.current_location,
          board_position: playerWithSupabaseProfile.board_position,
          bio: playerWithSupabaseProfile.bio,
          linkedin_url: playerWithSupabaseProfile.linkedin_url,
          instagram_url: playerWithSupabaseProfile.instagram_url,
          position: playerWithSupabaseProfile.position,
          current_company: playerWithSupabaseProfile.current_company,
